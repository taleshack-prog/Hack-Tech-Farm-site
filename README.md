...
| Homepage URL | `https://hacktechfarm.com.br` |
| Authorization callback URL | `https://hacktechfarm.com.br/api/auth/callback` |
...
3. **Senders & Domains** — verifique o domínio `hacktechfarm.com.br`. Sem isso o
...
| `CONTACT_TO` | `hacktechfarm@proton.me` |
